...
(function(g) {
    ...
    function r(a, b, c) {
        ...
        c && (c.attr && g(d).attr(c.attr),
            c.children && g.each(c.children, function(a, b) {
                d.appendChild(b)
            }),
            ...
            if (g.isPlainObject(c))
                ...
                if (v) {
                    ...
                    for (h = e.length; f < h; f++)
                        k = c.createAttribute(e[f].name.replace(":", "_dt_b_namespace_token_")),
                        k.value = e[f].value,
                        d.setAttributeNode(k)
                }
                c = z.serializeToString(c);
                v && (-1 === c.indexOf("<?xml") && (c = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + c),
    ...
    h.Client.prototype = {
        ...
        getHTML: function(a, b) {
            ...
            if (navigator.userAgent.match(/MSIE/)) {
                ...
                c += '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="' + f + 'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="' + a + '" height="' + b + '" id="' + this.movieId + '" align="middle"><param name="allowScriptAccess" value="always" /><param name="allowFullScreen" value="false" /><param name="movie" value="' + h.moviePath + '" /><param name="loop" value="false" /><param name="menu" value="false" /><param name="quality" value="best" /><param name="bgcolor" value="#ffffff" /><param name="flashvars" value="' + d + '"/><param name="wmode" value="transparent"/></object>'
            } else
        ...
        destroy: function() {
            var a = this;
            this.domElement && this.div && (g(this.div).remove(),
                this.div = this.domElement = null,
                g.each(h.clients, function(b, c) {
    ...
    h.hasFlash = function() {
        try {
            ...
            if (navigator.mimeTypes && navigator.mimeTypes["application/x-shockwave-flash"] !== u && navigator.mimeTypes["application/x-shockwave-flash"].enabledPlugin)
                return !0
        }
        return !1
    };
            ...
            var d = b.fieldBoundary,
                ...
                h = function(a) {
                    for (var b = "", c = 0, h = a.length; c < h; c++)
                        0 < c && (b += f),
                        b += d ? d + ("" + a[c]).replace(e, g + d) + d : a[c];
                    return b
                },
                n = b.header ? h(a.header) + c : "";
            b = b.footer && a.footer ? c + h(a.footer) : "";
            for (var m = [], p = 0, r = a.body.length; p < r; p++)
                m.push(h(a.body[p]));
            return {
                str: n + m.join(c) + b,
                rows: m.length
    ...
    l.Buttons.swfPath = "//cdn.datatables.net/buttons/" + l.Buttons.version + "/swf/flashExport.swf";
    ...
    l.ext.buttons.excelFlash = g.extend({}, y, {
        ...
        action: function(a, b, c, d) {
                ...
                m, n, p = function(a) {
                    ...
                    for (var b = 0, c = a.length; b < c; b++) {
                        ...
                        for (var p = 0, t = F.length; p < t; p++) {
                            var q = F[p];
                            if (a[b].match && !a[b].match(/^0\d+/) && a[b].match(q.match)) {
                                k = a[b].replace(/[^\d\.\-]/g, "");
                                q.fmt && (k = q.fmt(k));
                                k = r(e, "c", {
                                    attr: {
                        ...
                        }) : (q = a[b].replace ? a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "") : a[b],
                            k = r(e, "c", {
                                attr: {
                                    t: "inlineStr",
                                    r: l
            ...
            q.title && (p([q.title], f),
                l(f, k.header.length - 1));
            q.messageTop && (p([q.messageTop], f),
                l(f, k.header.length - 1));
            d.header && (p(k.header, f),
                g("row:last c", e).attr("s", "2"));
            for (var w = 0, v = k.body.length; w < v; w++)
                p(k.body[w], f);
            d.footer && k.footer && (p(k.footer, f),
                g("row:last c", e).attr("s", "2"));
            q.messageBottom && (p([q.messageBottom], f),
                l(f, k.header.length - 1));
            p = r(e, "cols");
            g("worksheet", e).prepend(p);
            l = 0;
            for (w = k.header.length; l < w; l++)
                p.appendChild(r(e, "col", {
                    attr: {
                        min: l + 1,
                        max: l + 1,
                        width: G(k, l),
    ...
    l.ext.buttons.pdfFlash = g.extend({}, y, {
