...
(function(d) {
    ...
    d.extend(t.prototype, {
        ...
        add: function(a, b) {
            ...
            if ("string" === typeof b) {
                b = b.split("-");
                c = this.s;
                for (var d = 0, f = b.length - 1; d < f; d++)
                    c = c.buttons[1 * b[d]];
                c = c.buttons;
                b = 1 * b[b.length - 1]
            }
        ...
        processing: function(a, b) {
            a = this._nodeToButton(a);
            if (b === l)
                return d(a.node).hasClass("processing");
        ...
        _buildButton: function(a, b) {
            ...
            e.tag ? (f = d("<" + e.tag + "/>").html(h(a.text)).addClass(e.className),
                "a" === e.tag.toLowerCase() && f.attr("href", "#"),
                m.append(f)) : m.html(h(a.text));
            ...
            if (!b._buttonsHandled) {
                var c = function(e) {
                    for (var f = 0, g = e.length; f < g; f++) {
                        var h = e[f].conf,
                            k = e[f].node;
                        h.key && (h.key === a ? (b._buttonsHandled = !0,
                            d(k).click()) : !d.isPlainObject(h.key) || h.key.key !== a || h.key.shiftKey && !b.shiftKey || h.key.altKey && !b.altKey || h.key.ctrlKey && !b.ctrlKey || h.key.metaKey && !b.metaKey || (b._buttonsHandled = !0,
                            d(k).click()));
        ...
        var c = [],
            ...
            f = function(a) {
                if (d.isArray(a))
                    ...
                    "string" === typeof a ? -1 !== a.indexOf(",") ? f(a.split(",")) : (a = d.inArray(d.trim(a), e), -1 !== a && c.push(b[a].inst)) : "number" === typeof a && c.push(b[a].inst)
            };
        f(a);
        return c
    };
    t.buttonSelector = function(a, b) {
        for (var c = [], e = function(a, b, c) {
                for (var d, f, g = 0, k = b.length; g < k; g++)
                    if (d = b[g])
                        f = c !== l ? c + g : g + "",
                        a.push({
                            node: d.node,
                ...
                if (d.isArray(a) || a instanceof d)
                    ...
                    "object" === typeof a && a.nodeName && (h = d.inArray(a, k), -1 !== h && c.push({
                        inst: b,
                        node: k[h]
                    }))
    ...
    d.extend(r, {
        collection: {
            ...
            action: function(a, b, c, e) {
                ...
                if (!a) {
                    ...
                    g.length && (k = d(".dt-button-collection").position(),
                        l = g,
        ...
        copy: function(a, b) {
            if (r.copyHtml5)
                return "copyHtml5";
            if (r.copyFlash && r.copyFlash.available(a, b))
                return "copyFlash"
        },
        csv: function(a, b) {
            if (r.csvHtml5 && r.csvHtml5.available(a, b))
                return "csvHtml5";
            if (r.csvFlash && r.csvFlash.available(a, b))
                return "csvFlash"
        },
        excel: function(a, b) {
            if (r.excelHtml5 && r.excelHtml5.available(a, b))
                return "excelHtml5";
            if (r.excelFlash && r.excelFlash.available(a, b))
                return "excelFlash"
        },
        pdf: function(a, b) {
            if (r.pdfHtml5 && r.pdfHtml5.available(a, b))
                return "pdfHtml5";
            if (r.pdfFlash && r.pdfFlash.available(a, b))
                return "pdfFlash"
        },
    ...
    p.Api.register("buttons()", function(a, b) {
        ...
        var c = this.iterator(!0, "table", function(c) {
            if (c._buttons)
                return t.buttonSelector(t.instanceSelector(a, c._buttons), b)
        }, !0);
        c._groupSelector = a;
        return c
    });
    ...
    p.Api.registerPlural("buttons().active()", "button().active()", function(a) {
    ...
    p.Api.register(["buttons().disable()", "button().disable()"], function() {
    ...
    p.Api.register("button().add()", function(a, b) {
        var c = this.context;
        c.length && (c = t.instanceSelector(this._groupSelector, c[0]._buttons),
    ...
    var w;
    p.Api.register("buttons.info()", function(a, b, c) {
        var e = this;
        if (!1 === a)
    ...
    p.Api.register("buttons.exportData()", function(a) {
        if (this.context.length)
            return D(new p.Api(this.context[0]), a)
    });
    p.Api.register("buttons.exportInfo()", function(a) {
        ...
        c === l || null === c ? c = null : (-1 !== c.indexOf("*") && (c = d.trim(c.replace("*", d("head > title").text()))),
        ...
        D = function(a, b) {
            var c = d.extend(!0, {}, {
                ...
                e = function(a) {
                    ...
                    c.decodeEntities && (A.innerHTML = a,
                        a = A.value);
                    return a
                };
            ...
            a.select && "function" === typeof a.select.info && g.selected === l && a.rows(c.rows, d.extend({
                selected: !0
            }, g)).any() && d.extend(g, {
                selected: !0
            });
            ...
            for (var k = b.length, p = [], m = 0, n = 0, q = 0 < k ? g.length / k : 0; n < q; n++) {
                for (var t = [k], r = 0; r < k; r++)
                    t[r] = c.format.body(g[m], n, r, h[m]),
                    m++;
                p[n] = t
            }
            b = {
    ...
    d(n).on("init.dt plugin-init.dt", function(a, b) {
        "dt" === a.namespace && (a = b.oInit.buttons || p.defaults.buttons) && !b._buttons && (new t(b, a)).container()
    });
    p.ext.feature.push({
        fnInit: u,
        cFeature: "B"
